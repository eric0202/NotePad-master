...
//        getListView().setOnCreateContextMenuListener(this);
        ...
        getListView().setMultiChoiceModeListener(new AbsListView.MultiChoiceModeListener()
            ...
            public void onItemCheckedStateChanged(ActionMode actionMode, int i, long l, boolean b) {
                if(b){
                    toDel.add(String.valueOf(l));
                }
                else{
                    toDel.remove(String.valueOf(l));
                }
            }

            @Override
            public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
                actionMode.getMenuInflater().inflate(R.menu.dl_items, menu);
                return true;
            }
            ...
            public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
                ...
                for(int i=0; i<toDel.size(); i++){
                   noteUri = ContentUris.withAppendedId(getIntent().getData(), Integer.parseInt(String.valueOf(toDel.get(i))));
        ...
        // noteslist_item.xml
        int[] viewIDs = { android.R.id.text1 , R.id.time_stamp};
...
//END_INCLUDE(copy)
        case R.id.context_delete:
            ...
            // UI thread.
            Toast.makeText(getApplicationContext(),"id: "+info.id,Toast.LENGTH_LONG);
            getContentResolver().delete(
                noteUri,  // The URI of the provider
                null,     // No where clause is needed, since only a single note ID is being
                          // passed in.
    ...
    ActionMode.Callback cb = new ActionMode.Callback() {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            getMenuInflater().inflate(R.menu.dl_items, menu);
            return true;
        }
